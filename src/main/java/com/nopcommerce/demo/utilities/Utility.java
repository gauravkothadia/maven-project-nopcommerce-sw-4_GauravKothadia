...
public class Utility extends ManageBrowser {
    ...
    /**
     * This method will click on element By locator
     */
    public void clickOnElement(By by) {
        WebElement loginLink = findSingleElement(by);
        loginLink.click();
    }
...
//*************************** Action Methods ***************************************//
    ...
    //*********Gaurav's created methods******START********
     ...
     */
    public void clearingText(By by){
        findSingleElement(by).clear();
    }

    /*
    Getting text from element attribute value.
     */
    public String getElementArributeValue(By by, String attributeName){
        return findSingleElement(by).getAttribute(attributeName);
    }
