...
public class PropertyReader {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(System.getProperty("user.dir")+"/src/test/java/resources/propertiesfile/config.properties");

        System.out.println(getInstance().getProperty("browser"));
        System.out.println(getInstance().getProperty("baseUrl"));
        System.out.println(getInstance().getProperty("baseUrl1"));
        // if null returns that means property name not available.
        // if Property Not found = that means path is wrong.
